    ...
    <div class="settings-grid">
        <section class="panel settings-card settings-profile">
            ...
            <div class="settings-details">
                ...
                <div><span class="settings-detail-icon" aria-hidden="true">◷</span><span>Member Since</span><strong>July 2026</strong></div>
            </div>
        </section>
...
html[data-theme="dark"] .settings-theme-card{border-color:var(--line);background:var(--surface);color:var(--ink)}html[data-theme="dark"] .settings-profile-main img{border-color:#286d49}html[data-theme="dark"] .settings-profile-main,html[data-theme="dark"] .settings-details>div,html[data-theme="dark"] .sync-grid>div{background:var(--surface)}html[data-theme="dark"] .settings-maintenance-button{background:var(--surface)}html[data-theme="dark"] .settings-input-wrap>span{color:#b5cabe}
</style>
